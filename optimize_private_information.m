...
% test if Parallel computing toolbox is installed, and if yes use it.
...
switch mode
    case 'fmin'
        opt = optimoptions('fminunc','display',verb,'UseParallel',use_parallel_flag);
    case 'psw'
        opt = optimoptions('particleswarm','display',verb,'UseParallel',use_parallel_flag);
end
